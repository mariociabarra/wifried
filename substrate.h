...
void ZEHookFunction(void *symbol, void *replace, void **result);
...
template <typename Type_>
static inline void ZEHookFunction(Type_ *symbol, Type_ *replace, Type_ **result) {
    return ZEHookFunction(
...
template <typename Type_>
static inline void ZEHookFunction(Type_ *symbol, Type_ *replace) {
    return ZEHookFunction(symbol, replace, reinterpret_cast<Type_ **>(NULL));
}
